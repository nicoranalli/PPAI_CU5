...
namespace PPAI_CU5.Base_De_Datos
{
    public class Datos
    {
            ...
            List<Vino> vinos = new List<Vino>
        {
            ...
            new Vino(2021, "imagen3.jpg", "Vino Joven", "Notas de cata ligeras y frescas", 1200.00f, bodega2, listaVarietales3, listaMaridajes3),
            new Vino(2018, "imagen4.jpg", "Vino Gran Reserva", "Notas de cata robustas y especiadas", 2500.25f, bodega2, listaVarietales4, listaMaridajes4),
